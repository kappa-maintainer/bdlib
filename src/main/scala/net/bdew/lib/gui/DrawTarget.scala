...
trait DrawTarget {
  ...
  def drawTexture(r: Rect, t: Texture, color: Color = Color.white): Unit
  def drawText(text: String, p: Point, color: Color, shadow: Boolean): Unit
  def drawTextMultiline(text: String, r: Rect, color: Color): Unit
