...
object RecipesHelper {
  /**
    ...
    */
  def loadConfigs(modName: String, listResource: String, configDir: File, resBaseName: String, loader: RecipeLoader): Unit = {
  ...
  def tryLoadConfig(reader: Reader, path: String, modName: String, loader: RecipeLoader): Unit = {
